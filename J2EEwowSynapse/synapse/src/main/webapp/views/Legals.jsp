...
<html>
<head>
<title>Synapse Gaming | Conditions générales</title>
<!-- Meta -->
...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/legals.css" />">
<link rel="stylesheet" type="text/css"
		...
		<div id="legals-wrapper">
			<div id="legals-container">
				...
				<p>
					...
					utilisateurs du site <a href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>
					l'identité des différents intervenants dans le cadre de sa
					réalisation et de son suivi :
				</p>
				<p>
					<strong>Propriétaire</strong> : Synapse – Guilde – 81 avenue Pierre
					Corneille<br /> <strong>Créateur</strong> : <a
						href="www.synapsegaming.fr">Meidi Airouche</a><br /> <strong>Responsable
						publication</strong> : Romain Klein-sujka – klein-sujka@hotmail.fr<br />
					Le responsable publication est une personne physique ou une
					personne morale.<br /> <strong>Webmaster</strong> : Meidi Airouche
					– meidi.airouche@gmail.com<br /> <strong>Hébergeur</strong> :
					online.net – ONLINE – BP438 – 75366 PARIS CEDEX 08<br /> Crédits :
					les mentions légales ont étés générées et offertes par Subdelirium
				</p>

				<h3>2. Conditions générales d’utilisation du site et des
					services proposés.</h3>
				<p>
					L’utilisation du site <a href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>
				...
				<p>Ce site est normalement accessible à tout moment aux
					utilisateurs. Une interruption pour raison de maintenance technique
					peut être toutefois décidée par Synapse, qui s’efforcera alors de
					communiquer préalablement aux utilisateurs les dates et heures de
					l’intervention.</p>
				<p>
					Le site <a href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>
					est mis à jour régulièrement par Romain Klein-sujka. De la même
				...
				<p>
					Le site <a href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a> a
					pour objet de fournir une information concernant l’ensemble des
					activités de la société.
				</p>
				<p>
					Synapse s’efforce de fournir sur le site <a
						href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>
				...
				<p>
					Tous les informations indiquées sur le site <a
						href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>
					sont données à titre indicatif, et sont susceptibles d’évoluer. Par
					ailleurs, les renseignements figurant sur le site <a
						href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a> ne
				...
				<p>Synapse est propriétaire des droits de propriété
				...
				<p>Toute reproduction, représentation, modification,
					...
					autorisation écrite préalable de : Synapse.</p>
				<p>Toute exploitation non autorisée du site ou de l’un
				...
				<p>Synapse ne pourra être tenue responsable des dommages directs
					et indirects causés au matériel de l’utilisateur, lors de l’accès
					au site www.synapsegaming.fr, et résultant soit de l’utilisation
					d’un matériel ne répondant pas aux spécifications indiquées au
					point 4, soit de l’apparition d’un bug ou d’une incompatibilité.</p>
				<p>
					Synapse ne pourra également être tenue responsable des dommages
					indirects (tels par exemple qu’une perte de marché ou perte d’une
					chance) consécutifs à l’utilisation du site <a
						href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>.
				</p>
				<p>Des espaces interactifs (possibilité de poser des questions
					dans l’espace contact) sont à la disposition des utilisateurs.
					Synapse se réserve le droit de supprimer, sans mise en demeure
					...
					Synapse se réserve également la possibilité de mettre en cause la
				...
				<p>En France, les données personnelles sont notamment protégées
					...
					du 24 octobre 1995.</p>
				<p>
					A l'occasion de l'utilisation du site <a
						href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>,
					peuvent êtres recueillies : l'URL des liens par l'intermédiaire
					desquels l'utilisateur a accédé au site <a
						href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>,
				...
				<p>
					En tout état de cause Synapse ne collecte des informations
					personnelles relatives à l'utilisateur que pour le besoin de
					certains services proposés par le site <a
						href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>.
					...
					est alors précisé à l'utilisateur du site <a
						href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>
					l’obligation ou non de fournir ces informations.
				</p>
				<p>Conformément aux dispositions des articles 38 et suivants de
				...
				<p>
					...
					l'hypothèse du rachat de Synapse et de ses droits permettrait la
				...
				<p>Le site susnommé est déclaré à la CNIL sous le numéro DI-008.</p>
				<p>Les bases de données sont protégées par les dispositions de
					la loi du 1er juillet 1998 transposant la directive 96/9 du 11 mars
					1996 relative à la protection juridique des bases de données.</p>
				<h3>8. Liens hypertextes et cookies.</h3>
				<p>
					Le site <a href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>
					contient un certain nombre de liens hypertextes vers d’autres
					sites, mis en place avec l’autorisation de Synapse. Cependant,
					Synapse n’a pas la possibilité de vérifier le contenu des sites
					ainsi visités, et n’assumera en conséquence aucune responsabilité
					de ce fait.
				</p>
				<p>
					La navigation sur le site <a href="http://www.synapsegaming.fr/"
						title="Synapse - www.synapsegaming.fr">www.synapsegaming.fr</a>
				...
				<p>Le refus d’installation d’un cookie peut entraîner
					...
					refuser l’installation des cookies :</p>
				<p>Sous Internet Explorer : onglet outil (pictogramme en forme
					de rouage en haut a droite) / options internet. Cliquez sur
					Confidentialité et choisissez Bloquer tous les cookies. Validez sur
					Ok.</p>
				<p>Sous Firefox : en haut de la fenêtre du navigateur, cliquez
					sur le bouton Firefox, puis aller dans l'onglet Options. Cliquer
					sur l'onglet Vie privée. Paramétrez les Règles de conservation sur
				...
				<p>Loi n° 78-87 du 6 janvier 1978, notamment modifiée par la loi
					n° 2004-801 du 6 août 2004 relative à l'informatique, aux fichiers
					et aux libertés.</p>
				<p>Loi n° 2004-575 du 21 juin 2004 pour la confiance dans
					l'économie numérique.</p>
				<h3>11. Lexique.</h3>
				<p>Utilisateur : Internaute se connectant, utilisant le site
					susnommé.</p>
				<p>Informations personnelles : « les informations qui
