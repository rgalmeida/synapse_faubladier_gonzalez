...
<html>
<head>
    <title>Synapse Gaming | ${ aboutArticle.title }</title>
    <!-- Meta -->
		...
		<div id="blog-container">
			<div id="blog">
				<div id="blog-header" class="blog-header">
					[A propos], <i>le <fmt:formatDate value="${ aboutArticle.dateCreate }" pattern="dd/MM/yyyy" /></i> par ${ aboutArticle.author.surname } <i>'${ aboutArticle.author.nickname }'</i> ${ aboutArticle.author.name }
				</div>
				<div id="blog-title" class="blog-title">
					${ aboutArticle.title }
				</div>
				<div id="blog-desc" class="blog-desc">
					${ aboutArticle.description }
				</div>
				<div id="blog-header-img" class="blog-coverImage">
					<img src="<c:url value="${ aboutArticle.imageHeader }" />"/>
				</div>
				<div id="blog-content" class="blog-content">
					${ aboutArticle.content }
				</div>
				<div id="blogArticle-clear" class="clear"></div>
				<br/><br/>
			</div>
		</div>
	</div>
