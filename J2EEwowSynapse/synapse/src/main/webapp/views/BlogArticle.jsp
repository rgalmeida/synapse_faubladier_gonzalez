		...
		<div id="blog-container">
			<div id="blog">
				<div id="blog-header" class="blog-header">
					[Blogs], <i>le <fmt:formatDate value="${ blog.dateCreate }" pattern="dd/MM/yyyy" /></i> par ${ blog.author.surname } <i>'${ blog.author.nickname }'</i> ${ blog.author.name }
				</div>
				...
				<div id="blog-header-img" class="blog-coverImage">
					<img src="<c:url value="${ blog.imageHeader }" />"/>
				</div>
